...
- [Lab 2：物理内存和页表](#lab-2物理内存和页表)
  - [实验内容](#实验内容)
  - [实验目的](#实验目的)
  - [实验内容](#实验内容-1)
    - [练习1：理解first-fit 连续物理内存分配算法](#练习1理解first-fit-连续物理内存分配算法)
    - [练习2：实现 Best-Fit 连续物理内存分配算法](#练习2实现-best-fit-连续物理内存分配算法)
    - [扩展练习Challenge：buddy system（伙伴系统）分配算法](#扩展练习challengebuddy-system伙伴系统分配算法)
    - [扩展练习Challenge：硬件的可用物理内存范围的获取方法](#扩展练习challenge硬件的可用物理内存范围的获取方法)
