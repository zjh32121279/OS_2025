...
- [Lab4：进程管理](#lab4进程管理)
  ...
  - [练习2：为新创建的内核线程分配资源](#练习2为新创建的内核线程分配资源)
    ...
    - [PID唯一性分析](#pid唯一性分析)
    - [结论](#结论)
  - [练习3: 编写proc\_run 函数](#练习3-编写proc_run-函数)
    - [实现思路](#实现思路)
    - [实现过程](#实现过程)
    - [本实验创建的内核线程](#本实验创建的内核线程)
  - [扩展练习Challenge](#扩展练习challenge)
    - [local\_intr\_save/restore中断开关机制](#local_intr_saverestore中断开关机制)
    - [分页模式的基本原理](#分页模式的基本原理)
    - [为什么get\_pte中的两段代码相似](#为什么get_pte中的两段代码相似)
    - [评价get\_pte函数：](#评价get_pte函数)
  - [运行结果](#运行结果)
